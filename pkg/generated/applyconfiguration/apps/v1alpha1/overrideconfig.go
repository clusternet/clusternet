...
type OverrideConfigApplyConfiguration struct {
	...
	FieldFormat   *v1alpha1.FieldFormatType `json:"fieldFormat,omitempty"`
}
...
func (b *OverrideConfigApplyConfiguration) WithFieldFormat(value v1alpha1.FieldFormatType) *OverrideConfigApplyConfiguration {
	b.FieldFormat = &value
	return b
}

...
// DescriptionApplyConfiguration represents a declarative configuration of the Description type for use
// with apply.
...
// Description constructs a declarative configuration of the Description type for use with
// apply.
func Description(name, namespace string) *DescriptionApplyConfiguration {
	b := &DescriptionApplyConfiguration{}
	b.WithName(name)
	b.WithNamespace(namespace)
	b.WithKind("Description")
...
func (b *DescriptionApplyConfiguration) ensureObjectMetaApplyConfigurationExists() {
...
func (b *DescriptionApplyConfiguration) GetName() *string {
	b.ensureObjectMetaApplyConfigurationExists()

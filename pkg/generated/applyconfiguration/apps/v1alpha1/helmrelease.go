...
// HelmReleaseApplyConfiguration represents a declarative configuration of the HelmRelease type for use
// with apply.
...
// HelmRelease constructs a declarative configuration of the HelmRelease type for use with
// apply.
...
func (b *HelmReleaseApplyConfiguration) GetName() *string {
	b.ensureObjectMetaApplyConfigurationExists()

...
// SubscriptionApplyConfiguration represents an declarative configuration of the Subscription type for use
// with apply.
...
// Subscription constructs an declarative configuration of the Subscription type for use with
// apply.

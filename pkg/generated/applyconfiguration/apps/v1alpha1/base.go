...
// BaseApplyConfiguration represents an declarative configuration of the Base type for use
// with apply.
...
// Base constructs an declarative configuration of the Base type for use with
// apply.

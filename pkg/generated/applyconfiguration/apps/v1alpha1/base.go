...
// BaseApplyConfiguration represents a declarative configuration of the Base type for use
// with apply.
...
// Base constructs a declarative configuration of the Base type for use with
// apply.
func Base(name, namespace string) *BaseApplyConfiguration {
	b := &BaseApplyConfiguration{}
	b.WithName(name)
...
func (b *BaseApplyConfiguration) ensureObjectMetaApplyConfigurationExists() {
...
func (b *BaseApplyConfiguration) GetName() *string {
	b.ensureObjectMetaApplyConfigurationExists()

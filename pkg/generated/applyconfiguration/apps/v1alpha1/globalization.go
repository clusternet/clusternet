...
// GlobalizationApplyConfiguration represents a declarative configuration of the Globalization type for use
// with apply.
...
// Globalization constructs a declarative configuration of the Globalization type for use with
// apply.
func Globalization(name string) *GlobalizationApplyConfiguration {
	b := &GlobalizationApplyConfiguration{}
	b.WithName(name)
	b.WithKind("Globalization")
...
func (b *GlobalizationApplyConfiguration) ensureObjectMetaApplyConfigurationExists() {
...
func (b *GlobalizationApplyConfiguration) GetName() *string {
	b.ensureObjectMetaApplyConfigurationExists()

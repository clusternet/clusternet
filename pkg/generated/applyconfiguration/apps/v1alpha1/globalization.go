...
// GlobalizationApplyConfiguration represents an declarative configuration of the Globalization type for use
// with apply.
...
// Globalization constructs an declarative configuration of the Globalization type for use with
// apply.

...
// FeedInventoryApplyConfiguration represents a declarative configuration of the FeedInventory type for use
// with apply.
...
// FeedInventory constructs a declarative configuration of the FeedInventory type for use with
// apply.
...
func (b *FeedInventoryApplyConfiguration) GetName() *string {
	b.ensureObjectMetaApplyConfigurationExists()

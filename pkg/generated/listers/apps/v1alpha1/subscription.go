...
type SubscriptionLister interface {
	...
	List(selector labels.Selector) (ret []*appsv1alpha1.Subscription, err error)
...
type subscriptionLister struct {
	listers.ResourceIndexer[*appsv1alpha1.Subscription]
}
...
func NewSubscriptionLister(indexer cache.Indexer) SubscriptionLister {
	return &subscriptionLister{listers.New[*appsv1alpha1.Subscription](indexer, appsv1alpha1.Resource("subscription"))}
}

// Subscriptions returns an object that can list and get Subscriptions.
func (s *subscriptionLister) Subscriptions(namespace string) SubscriptionNamespaceLister {
	return subscriptionNamespaceLister{listers.NewNamespaced[*appsv1alpha1.Subscription](s.ResourceIndexer, namespace)}
}
...
type SubscriptionNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*appsv1alpha1.Subscription, error)

...
func (c *FakeBases) UpdateStatus(ctx context.Context, base *v1alpha1.Base, opts v1.UpdateOptions) (*v1alpha1.Base, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(basesResource, "status", c.ns, base), &v1alpha1.Base{})

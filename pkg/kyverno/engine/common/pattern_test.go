...
func TestValidateValueWithStringPattern_WithSpace(t *testing.T) {
	assert.Assert(t, validateValueWithStringPattern(4, ">= 3"))
}

func TestValidateValueWithStringPattern_Ranges(t *testing.T) {
	assert.Assert(t, validateValueWithStringPattern(0, "0-2"))
	assert.Assert(t, validateValueWithStringPattern(1, "0-2"))
	assert.Assert(t, validateValueWithStringPattern(2, "0-2"))
	assert.Assert(t, !validateValueWithStringPattern(3, "0-2"))

	assert.Assert(t, validateValueWithStringPattern(0, "10!-20"))
	assert.Assert(t, !validateValueWithStringPattern(15, "10!-20"))
	assert.Assert(t, validateValueWithStringPattern(25, "10!-20"))

	assert.Assert(t, !validateValueWithStringPattern(0, "0.00001-2.00001"))
	assert.Assert(t, validateValueWithStringPattern(1, "0.00001-2.00001"))
	assert.Assert(t, validateValueWithStringPattern(2, "0.00001-2.00001"))
	assert.Assert(t, !validateValueWithStringPattern(2.0001, "0.00001-2.00001"))
	...
	assert.Assert(t, validateValueWithStringPattern(2, "2-2"))
	assert.Assert(t, !validateValueWithStringPattern(2, "2!-2"))

	assert.Assert(t, validateValueWithStringPattern(2.99999, "2.99998-3"))
	assert.Assert(t, validateValueWithStringPattern(2.99997, "2.99998!-3"))
	assert.Assert(t, validateValueWithStringPattern(3.00001, "2.99998!-3"))

	assert.Assert(t, validateValueWithStringPattern("256Mi", "128Mi-512Mi"))
	assert.Assert(t, !validateValueWithStringPattern("1024Mi", "128Mi-512Mi"))
	assert.Assert(t, !validateValueWithStringPattern("64Mi", "128Mi-512Mi"))
...
func TestValidateKernelVersion_NotEquals(t *testing.T) {
	assert.Assert(t, validateValueWithStringPattern("5.16.5-arch1-1", "!5.10.84-1"))
	assert.Assert(t, !validateValueWithStringPattern("5.10.84-1", "!5.10.84-1"))
	assert.Assert(t, validateValueWithStringPatterns("5.16.5-arch1-1", "!5.10.84-1 & !5.15.2-1"))
	assert.Assert(t, !validateValueWithStringPatterns("5.10.84-1", "!5.10.84-1 & !5.15.2-1"))
	assert.Assert(t, !validateValueWithStringPatterns("5.15.2-1", "!5.10.84-1 & !5.15.2-1"))
}

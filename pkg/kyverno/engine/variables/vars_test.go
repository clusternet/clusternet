...
import (
	...
	ju "github.com/clusternet/clusternet/pkg/kyverno/engine/jsonutils"
	"gotest.tools/assert"
)
...
func Test_subVars_success(t *testing.T) {
	...
	if _, err := SubstituteAll(ctx, pattern); err != nil {
		t.Error(err)
	}
}
...
func Test_subVars_with_JMESPath_At(t *testing.T) {
	...
	output, err := SubstituteAll(ctx, pattern)
	assert.NilError(t, err)
...
`)
	...
	pattern, err = SubstituteAll(ctx, pattern)
	assert.NilError(t, err)
...
func Test_SubstituteSuccess(t *testing.T) {
	...
	action := substituteVariablesIfAny(ctx, DefaultVariableResolver)
...
func Test_policyContextValidation(t *testing.T) {
	...
	_, err = SubstituteAll(ctx, contextMap)
...
// 	vars, err := SubstituteAllInRule(ctx, rule)
// 	assert.NilError(t, err)
...
func Test_SubstituteNull(t *testing.T) {
	...
	resolved, err := SubstituteAll(ctx, pattern)
	assert.NilError(t, err)
...
func Test_ReferenceSubstitution(t *testing.T) {
	...
	actualDocument, err := SubstituteAll(ctx, document)
	assert.NilError(t, err)
...
func TestFindAndShiftReferences_PositiveCase(t *testing.T) {
	...
	actualMessage := FindAndShiftReferences(message, "spec/jobTemplate", "pattern")
...
func TestFindAndShiftReferences_AnyPatternPositiveCase(t *testing.T) {
	...
	actualMessage := FindAndShiftReferences(message, "spec/jobTemplate", "anyPattern")

...
func (in *AnyAllConditions) DeepCopyInto(out *AnyAllConditions) {
	*out = *in
	if in.AnyConditions != nil {
		...
		*out = make([]KyvernoCondition, len(*in))
		for i := range *in {
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *KyvernoCondition) DeepCopyInto(out *KyvernoCondition) {
	*out = *in
	if in.RawKey != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new KyvernoCondition.
func (in *KyvernoCondition) DeepCopy() *KyvernoCondition {
	if in == nil {
		return nil
	}
	out := new(KyvernoCondition)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *KyvernoContextEntry) DeepCopyInto(out *KyvernoContextEntry) {
	*out = *in
	if in.Variable != nil {
		in, out := &in.Variable, &out.Variable
		*out = new(KyvernoVariable)
		(*in).DeepCopyInto(*out)
	}
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new KyvernoContextEntry.
func (in *KyvernoContextEntry) DeepCopy() *KyvernoContextEntry {
	if in == nil {
		return nil
	}
	out := new(KyvernoContextEntry)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *KyvernoForEachMutation) DeepCopyInto(out *KyvernoForEachMutation) {
	*out = *in
	if in.Context != nil {
		in, out := &in.Context, &out.Context
		*out = make([]KyvernoContextEntry, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new KyvernoForEachMutation.
func (in *KyvernoForEachMutation) DeepCopy() *KyvernoForEachMutation {
	if in == nil {
		return nil
	}
	out := new(KyvernoForEachMutation)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *KyvernoMutation) DeepCopyInto(out *KyvernoMutation) {
	*out = *in
	if in.RawPatchStrategicMerge != nil {
		in, out := &in.RawPatchStrategicMerge, &out.RawPatchStrategicMerge
		*out = new(apiextensionsv1.JSON)
	...
	if in.ForEachMutation != nil {
		...
		*out = make([]KyvernoForEachMutation, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new KyvernoMutation.
func (in *KyvernoMutation) DeepCopy() *KyvernoMutation {
	if in == nil {
		return nil
	}
	out := new(KyvernoMutation)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *KyvernoPatchConfig) DeepCopyInto(out *KyvernoPatchConfig) {
	*out = *in
	if in.Context != nil {
		in, out := &in.Context, &out.Context
		*out = make([]KyvernoContextEntry, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new KyvernoPatchConfig.
func (in *KyvernoPatchConfig) DeepCopy() *KyvernoPatchConfig {
	if in == nil {
		return nil
	}
	out := new(KyvernoPatchConfig)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *KyvernoVariable) DeepCopyInto(out *KyvernoVariable) {
	*out = *in
	if in.Value != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new KyvernoVariable.
func (in *KyvernoVariable) DeepCopy() *KyvernoVariable {
	if in == nil {
		return nil
	}
	out := new(KyvernoVariable)
...
func (in *OverrideConfig) DeepCopyInto(out *OverrideConfig) {
	*out = *in
	if in.KyvernoConfig != nil {
		in, out := &in.KyvernoConfig, &out.KyvernoConfig
		*out = new(KyvernoPatchConfig)
		(*in).DeepCopyInto(*out)
	}
	return

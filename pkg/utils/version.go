...
var (
	...
	// KubeV1180Alpha0 indicates the version of Kubernetes v1.18.0-alpha.0
	KubeV1180Alpha0 = version.MustParseSemantic("v1.18.0-alpha.0")
)
...
func ClusterLifecycleEnabled(kubeServerVersion string) (bool, error) {
	...
	return parsedVersion.AtLeast(KubeV1180Alpha0), nil
}

...
replace (
	...
	k8s.io/apimachinery => github.com/clusternet/apimachinery v0.23.0-alpha.0.0.20230202084300-ebad6af0b077
	k8s.io/apiserver => github.com/clusternet/apiserver v0.0.0-20230202114701-f83f62b1864c
)

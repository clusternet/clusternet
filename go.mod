...
replace (
	k8s.io/apimachinery => github.com/clusternet/apimachinery v0.23.0-alpha.0.0.20240218023726-899f88f5dcf4
	k8s.io/apiserver => github.com/clusternet/apiserver v0.0.0-20240218023443-e17a9e9cfec3
)

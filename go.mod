...
require (
	...
	github.com/dixudx/yacht v0.4.1
	...
	k8s.io/controller-manager v0.20.0-alpha.1.0.20230322071316-6250e416f513
...
replace (
	...
	k8s.io/apimachinery => github.com/clusternet/apimachinery v0.23.0-alpha.0.0.20230411032548-a2e9fbd1439c
	k8s.io/apiserver => github.com/clusternet/apiserver v0.0.0-20230411032400-a7b223da8fa4
)

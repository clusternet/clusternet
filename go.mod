...
replace (
	github.com/containerd/containerd => github.com/containerd/containerd v1.6.23
	...
	k8s.io/apimachinery => github.com/clusternet/apimachinery v0.23.0-alpha.0.0.20230523092635-7eefe36f6ee1
	k8s.io/apiserver => github.com/clusternet/apiserver v0.0.0-20230523093007-b234a7320705
)
